export const langStrings = {
	en: {
		...
		aboutSubtitle: "About",
		myName: "My name is",
		about: "I'm passionate about web development and I'm studying (and enjoying a lot) blockchain development. Started programming at the age of 17. By the age of 18, I discovered React and completely fell in love with it. I also love backend, especially NodeJs and Django! I think my goal in life is to eventually work with something that I know will have a positive impact on people's lives :)",
		ed: "Education",
	...
	pt: {
		hello: "Olá, eu sou",
		dev: "Desenvolvedora Fullstack",

		aboutTitle: "Sobre mim",
		aboutSubtitle: "Sobre",
		myName: "Meu nome é",
		about: "Eu sou apaixonada por desenvolvimento web e estou estudando (e gostando muito) de desenvolvimento na blockchain. Comecei a programar com 17 anos de idade. Aos 18, descobri o React e me apaixonei completamente. Eu também amo o backend, especialmente NodeJs e Django! Meu objetivo na vida é eventualmente trabalhar em algo que eu sei que vai ter um impacto positivo na vida das pessoas :)",
		ed: "Educação",
		ufc: "Universidade Federal do Ceará",

		projectsTitle: "Projetos",
		projectsSubtitle: "Projeto",
		...
		status: "Presente",
		desc: "Desenvolvedora Fullstack",

		skillsTitle: "Habilidades",
		skillsSubtitle: "Habilidade",
		wd: "Desenvolvimento Web",
		vc: "Controle de Versionamento",
		db: "Bancos de Dados",
		s: "Estudando",
